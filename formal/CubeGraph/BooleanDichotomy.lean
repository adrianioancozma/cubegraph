/-
  CubeGraph/BooleanDichotomy.lean
  ...
  **Schaefer's Dichotomy (1978)**: A constraint language Γ over {0,1} is
  ...
  encoded as Fin 256 bitmasks). 0 new axioms.
  ...
  DEPENDENCIES:
  - NonAffine.lean (IsAffineSubspace, vertexXor, IsPowerOfTwo, seven_not_pow2)
  - AffineComposition.lean (affine_mask_pow2, isAffineMask, rank contrast)
...
/-- (S5) Affine: S is an affine subspace of GF(2)^3.
    Reuses the definition pattern from NonAffine.lean. -/
...
/-- **THE DICHOTOMY THEOREM**: Schaefer's classification meets CubeGraph.
    ...
    appeal to previously proven algebraic theorems. -/
