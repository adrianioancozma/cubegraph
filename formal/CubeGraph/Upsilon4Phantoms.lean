/-
  CubeGraph/Upsilon4Phantoms.lean
  ...
  See: formal/CubeGraph/Theta3NonAffine.lean (3-SAT gap sets are non-affine)
  See: formal/CubeGraph/Kappa3AffineComposition.lean (XOR preserves structure on affine)
  See: formal/CubeGraph/Lambda3IrreversibleDecay.lean (OR is irreversible)
