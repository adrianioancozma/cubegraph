/-
  CubeGraph/Beta5CoverageBoundary.lean
  ...
  See: Kappa4CoverageRate.lean (8/7 shrinkage, clauses_per_bit_bounds)
  ...
  0 sorry, 0 new axioms. Uses Schoenebeck axioms (already declared).
-/
