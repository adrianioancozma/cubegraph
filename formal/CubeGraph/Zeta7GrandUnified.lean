/-
  CubeGraph/Zeta7GrandUnified.lean
  ...
  Each component is proven (0 sorry) in its own file. This file imports them
  ...
  See: Upsilon3GrandUnified.lean (previous grand unified, 9 dimensions)
...
import CubeGraph.Theta3NonAffine           -- Component 1: 7 ≠ 2^k
-- Component 2 (Lambda3): rank1_aperiodic available via BandSemigroup (transitive)
import CubeGraph.Nu6BooleanInvolution      -- Component 3: involutions = permutations
import CubeGraph.Gamma6KRConsequences      -- Component 4: Z/2Z ⊆ T₃*, KR ≥ 1
import CubeGraph.Delta6LargerGroups        -- Component 5: Z/2Z maximality
import CubeGraph.Theta6BooleanCollapse     -- Component 6: boolean collapse barrier
import CubeGraph.Pi6EnrichedKR             -- Component 7: NOT doesn't increase KR
import CubeGraph.Epsilon7ParityObstruction -- Component 8: parity obstruction
import CubeGraph.Chi6CycleBasis           -- Component 9: XOR vs OR cycle basis
import CubeGraph.Alpha7SheafOverCycleSpace -- Component 10: sheaf over cycle space
import CubeGraph.Beta7UniversalWordProblem -- Component 11: single vs universal word
import CubeGraph.Gamma7GenerationEnumeration -- Component 12: function vs relation
