/-
  CubeGraph/Omega6MonotoneLayers.lean
  ...
  See: Pi6EnrichedKR.lean (NOT enrichment, KR=1)
  See: Alpha5BinomComplete.lean (all gates stay rank ≤ 1)
