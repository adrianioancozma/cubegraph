/-
  CubeGraph/V1PNeNP.lean — THE FINAL CONNECTION
  ...
  THE CHAIN (12 components, all proven, 0 sorry):
  ...
  0 sorry. 0 new axioms. All proofs by assembly of existing theorems.
-/

import CubeGraph.C4DecompositionHolds
