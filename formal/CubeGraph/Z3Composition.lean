/-
  ...
  See: FlatBundleFailure.lean, BarringtonConnection.lean
...
/-- h2Monodromy: no diagonal true entries. Swap has no fixed points.
...
/-- **KR=1 insufficient**: monodromy traceless + nonzero + flat bundle + consistency gap.
