/-
  ...
  Dependencies:
  - CubeGraph/IrreversibleDecay.lean (rank-1 absorbing, monotone)
  - CubeGraph/FanOutStructure.lean (fan-out preserves everything)
  - CubeGraph/NonAffine.lean (7 gaps non-affine)
...
import CubeGraph.FanOutStructure
...
/-! ## Section 8: Fan-Out Preserves Rank (from Zeta4)
  ...
  Re-exported from FanOutStructure.lean. -/
