/-
  ...
  See: formal/CubeGraph/NonAffine.lean (non-affinity PROVEN)
  See: formal/CubeGraph/IrreversibleDecay.lean (irreversible rank decay)
  See: formal/CubeGraph/AffineComposition.lean (affine composition preserved)
-/
