/-
  CubeGraph/Pi5AffineFactorization.lean
  ...
  Key results (25 theorems, 0 sorry):
  ...
  0 sorry, 0 axioms beyond those in Basic.lean.

  See: formal/CubeGraph/Theta3NonAffine.lean (7 gaps are non-affine)
  See: formal/CubeGraph/Kappa3AffineComposition.lean (affine composition)
