/-
  CubeGraph/TransferConstrained.lean — Transfer-Constrained Depth Bound
  ...
  (B) ALGEBRAIC STABILIZATION: Transfer-aligned proofs have depth ≤ 2.
      ...
      This IS proven: rank-1 aperiodic (M³ = M²) and
...
/-- **The Delta2 Theorem**: From transfer alignment to Frege exponential.
    ...
    as the ONLY open hypothesis. Everything else is proven (+ axioms
...
/- REMOVED (2026-03-24): `unconditional_frege_bound` was a re-export of
...
/-! ## HONEST ACCOUNTING
    ...
    - unconditional_frege_bound: REMOVED (depended on unsound frege_simulation)
    ...
    - minFregeSize, bsw_with_formula_size (FregeLowerBound)
