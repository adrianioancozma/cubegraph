/-
  CubeGraph/PositiveRefutation.lean — Positive Refutation Analysis for 3-CNF Frege
  ...
  See: ResolutionFIP.lean (monotonicity theory, PRP definition)
  See: FregeModel.lean (Frege proof model, soundness)
  See: InterpolationGame.lean (FIP conditional chain)
  See: FIPResolution.lean (FIP structural analysis)
-/

import CubeGraph.ResolutionFIP
