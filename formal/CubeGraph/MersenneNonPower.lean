/-
  CubeGraph/MersenneNonPower.lean
  ...
  DEPENDENCIES:
  - UniversalNonAffine.lean (mersenne_not_power, extraction_principle)
  - FinalGap.lean (irreversible_decay_implies_exponential for p=2)
...
/-! ## Section 1: The General Arithmetic Theorem
  ...
  This is PROVEN in UniversalNonAffine.lean and re-exported here. -/
...
/-! ## Section 6: The Complete Chain for p = 2
  ...
  lower bound is PROVEN in FinalGap.lean.
...
/-- **Boolean Complete Chain** (p=2, d=3): The full path from arithmetic
    to complexity, proven with  (1 axiom: Schoenebeck).
