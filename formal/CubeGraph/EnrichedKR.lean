/-
  ...
  See: BooleanInvolution.lean (boolean involutions = permutation matrices)
  See: ReesStructure.lean (T₃* = {I} ∪ Rees⁰(Z/2Z,2,2;P) ∪ {0})
  See: KRConsequences.lean (KR ≥ 1 from Z/2Z in T₃*)
-/
