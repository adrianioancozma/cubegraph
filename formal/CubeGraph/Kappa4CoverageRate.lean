/-
  CubeGraph/Kappa4CoverageRate.lean
  ...
  See: Theta3NonAffine.lean (gap count 7 is not a power of 2)
  See: Rank1Algebra.lean (rank-1 composition law)
  See: agents/2026-03-22-kappa4_coverage_v2.py (experimental verification)

  0 sorry, 0 axioms. All proofs by native_decide on finite domains.
-/
