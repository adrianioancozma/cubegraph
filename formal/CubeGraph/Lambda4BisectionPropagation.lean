/-
  CubeGraph/Lambda4BisectionPropagation.lean
  ...
  All proofs by native_decide on finite domains. 0 sorry, 0 axioms.

  See: CubeGraph/Theta3NonAffine.lean (3-SAT gap sets are non-affine)
  See: CubeGraph/Nu3FiveViews.lean (five views of the P/NP dichotomy)
  See: CubeGraph/Kappa3AffineComposition.lean (affine structure under composition)
-/
