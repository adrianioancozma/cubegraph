/-
  CubeGraph/BoolOrNonPerm.lean
  CLOSING THE PSI7 BOOLOOR GAP — HasMultiRow theory and applications.

  GeneralProjection.lean has a gap at the boolOr(non-perm, non-perm) case.
...
import CubeGraph.CircuitProjection
...
/-- **Ω7.12 — THE GAP-CLOSING LEMMA**: For any two BoolMat 8 matrices that
    ...
    This theorem directly closes the Psi7 gap at boolOr(non-perm, non-perm)
