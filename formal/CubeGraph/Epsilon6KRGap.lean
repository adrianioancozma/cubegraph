/-
  ...
  See: Chi5SyntacticMonoid.lean (trace language not star-free)
  See: Gamma6KRConsequences.lean (Z/2Z in T₃*, KR ≥ 1)
  See: Alpha6SyntacticConsequences.lean (permutation matrices, S₅)
...
import CubeGraph.Alpha6SyntacticConsequences
