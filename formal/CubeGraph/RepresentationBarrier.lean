/-
  CubeGraph/RepresentationBarrier.lean
  ...
  See: KRConsequences.lean (Z/2Z ⊆ T₃*)
  See: MonodromySquared.lean (h2Monodromy computation)
  See: LargerGroups.lean (rich monodromies collapse)
