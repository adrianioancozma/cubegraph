/-
  ...
  Builds on:
    NonAffine.lean — non-affinity of 7-gap sets, IsPowerOfTwo, seven_not_pow2
    AffineComposition.lean — 51 affine subspaces enumerated
...
/-! ## Section 6: The Cascading Diagonal — Non-Affinity Propagates Through Composition
  ...
  Step 3: OR/AND composition causes rank decay — AffineComposition.lean
