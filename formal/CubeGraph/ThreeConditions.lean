/-
  CubeGraph/ThreeConditions.lean
  ...
  C1 — ODD GAP SET (parity obstruction):
    ...
    Formalized in: ParityObstruction.lean
  ...
  C2 — NON-AFFINE (absorptive semiring):
    ...
    Formalized in: NonAffine.lean, InvertibilityBarrier.lean
  ...
  C3 — FIBER > 1 (relational, branching):
    ...
    Formalized in: FiberDichotomy.lean, GenerationEnumeration.lean
  ...
  0 axioms. 20 theorems.

  See: ParityObstruction.lean (C1: parity obstruction, 22 theorems)
  See: NonAffine.lean (C2: non-affine gap sets)
  See: InvertibilityBarrier.lean (C2: OR vs XOR invertibility)
  See: FiberDichotomy.lean (C3: fiber size dichotomy)
  See: GenerationEnumeration.lean (C3: functional vs relational)
...
import CubeGraph.GenerationEnumeration
import CubeGraph.AffineComposition
