/-
  CubeGraph/NonInvertibility.lean — Agent-Rho2 Gen12
  ...
  (9) Frege near-quadratic: REMOVED (depended on unsound frege_simulation)
  ...
  See: FregeLowerBound.lean (frege_near_quadratic removed — unsound frege_simulation)
...
/-! ## Section 5: The Complete Proof Complexity Landscape
  ...
  What non-invertibility eliminates (all proven + axioms):
  ...
  - General Frege (frege_near_quadratic — REMOVED, depended on unsound frege_simulation)
...
/-! ## Section 7: Honest Accounting
  ...
  WHAT THIS FILE PROVES (formally beyond inherited axioms):
