/-
  CubeGraph/Gamma6KRConsequences.lean
  Krohn-Rhodes complexity ≥ 1 for T₃*: h2Monodromy generates Z/2Z.

  CRITICAL CORRECTION of Beta6MonodromySquared.lean:
  ...
  See: Beta6MonodromySquared.lean (the computation this builds on)
  See: BandSemigroup.lean (rank-1 = aperiodic, KR = 0)
  See: BarringtonConnection.lean (Barrington framework)
  See: Chi5SyntacticMonoid.lean (syntactic monoid of trace language)
  See: BorromeanAC0.lean (distributional AC⁰ lower bound)
-/

import CubeGraph.Beta6MonodromySquared
...
/-! ## Section 12: Correction of Beta6's Green's Relations Claim
  ...
  Beta6MonodromySquared.lean (line 210-215) states:
