/-
  CubeGraph/Sigma3Irrationality.lean
  ...
  Dependencies:
  - Theta3NonAffine.lean (non-affine gap sets, vertexXor, IsPowerOfTwo)
  - Lambda3IrreversibleDecay.lean (irreversible rank decay)
  - Kappa3AffineComposition.lean (affine composition preserves structure)
