/-
  CubeGraph/SearchDecision.lean — Search vs Decision on CubeGraph
  ...
  DEPENDENCIES:
  - WitnessProperties.lean (witness function, DT ≥ Ω(n))
  - CCLifting.lean (CC ≥ Ω(n) via GPW lifting)
...
/- COMMENTED OUT (2026-03-29 audit): decision_resolution_exponential
...
/- COMMENTED OUT (2026-03-29 audit): search_decision_theorem
   Depended on resolution_exponential_via_lifting which was removed.
...
/- COMMENTED OUT (2026-03-29 audit): exponential_absorbs_polynomial
   Depended on resolution_exponential_via_lifting which was removed.
...
/- COMMENTED OUT (2026-03-29 audit): three_lower_bound_paths
   Depended on resolution_exponential_via_lifting which was removed.
