/-
  CubeGraph/Psi3EffectiveBoundary.lean
  ...
  **Effective Boundary**: Given CubeGraph G and partial assignment sigma,
  ...
  Dependencies:
  - CubeGraph/Theta3NonAffine.lean (non-affine gap sets, IsPowerOfTwo)
  ...
  - CubeGraph/Lambda3IrreversibleDecay.lean (irreversible rank decay)
...
/-! ## Section 7: The Non-Affine Fiber Connection
  ...
  This forces the non-affine regime (Theta3NonAffine.lean). -/
