/-
  CubeGraph/MonotoneInterpolant.lean — Monotone Interpolation for 3-CNF Frege
  ...
  is MONOTONE (from GapConsistency.lean).
  ...
  . Imports: Zeta2FregeModel (Frege model), Basic (CubeGraph).
...
/-- **Complete theorem: the FIP chain for 3-CNF.**
    ...
    Unconditionally:
    - Gap consistency is monotone [PROVEN]
