/-
  CubeGraph/IrreversibleDecay.lean
  ...
  - 3-SAT clauses have 7 gaps (NonAffine.lean) -> non-affine
  ...
  - CubeGraph/NonAffine.lean (seven_not_pow2, threeSAT_non_affine)
...
/-! ## Section 5: The Full Connection -- Non-Affine -> Irreversible
  ...
  Steps 1-2 are from NonAffine.lean.
...
/-- 3-SAT clauses force non-affine gap sets.
    Re-exported from NonAffine.lean. -/
