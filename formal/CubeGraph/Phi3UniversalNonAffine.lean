/-
  CubeGraph/Phi3UniversalNonAffine.lean
  ...
  See: Theta3NonAffine.lean (GF(2)^3 specific case via exhaustive computation)
  See: Kappa3AffineComposition.lean (affine gap sets preserve structure)
-/
...
/-! ## Section 8: Connection to CubeGraph Framework
  ...
  In the CubeGraph framework (Theta3NonAffine.lean), the GF(2)^3 case was
