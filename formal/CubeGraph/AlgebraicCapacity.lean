/-
  CubeGraph/AlgebraicCapacity.lean
  ...
  KEY RESULTS (18 theorems + 4 definitions):
  ...
  See: KRConsequences.lean (Z/2Z in T₃*)
  See: LargerGroups.lean (support barrier, idempotent collapse)
  See: BooleanInvolution.lean (boolean involution = permutation matrix)
  See: ParityObstruction.lean (parity obstruction on odd sets)
  See: BooleanFermat.lean (period classification by rank)
