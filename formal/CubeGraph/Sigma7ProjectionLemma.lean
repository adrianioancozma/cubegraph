/-
  CubeGraph/Sigma7ProjectionLemma.lean
  ...
  See: Sigma5CircuitRigidity.lean (wire dependency, deep wire counting)
  See: Zeta4FanOut.lean (fan-out preserves structural invariants)
  See: Phi6ProjectionOneWay.lean (π as one-way function)
-/

import CubeGraph.Rho7AlgebraicCapacity
import CubeGraph.Pi6EnrichedKR
import CubeGraph.Tau6TwoLevel
