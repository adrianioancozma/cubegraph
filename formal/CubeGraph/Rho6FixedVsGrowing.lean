/-
  CubeGraph/Rho6FixedVsGrowing.lean
  ...
  See: Gamma6KRConsequences.lean (KR ≥ 1, Z/2Z in T₃*)
  See: Xi6ReesStructure.lean (T₃* = {I} ∪ Rees⁰(Z/2Z,2,2;P) ∪ {0}, KR = 1 exactly)
  See: Epsilon6KRGap.lean (KR gap: operators KR=0 vs language KR=1)
  See: Chi5SyntacticMonoid.lean (trace language definitions)
