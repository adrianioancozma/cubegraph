/-
  CubeGraph/Psi6CubeGraph2Proof.lean
  ...
  Dependencies: Tau6TwoLevel.lean, Phi6ProjectionOneWay.lean,
                Gamma6KRConsequences.lean (via Phi6's imports)
-/

import CubeGraph.Phi6ProjectionOneWay
...
/-- **Psi6.4**: If two assignments agree on all variables that appear
    ...
    Uses projection_eq_of_agree from Tau6TwoLevel.lean. -/
...
/-- **Psi6.5**: Conversely, distinct values on covered variables yield
    ...
    Uses flip_changes_all_cubes from Tau6TwoLevel.lean. -/
