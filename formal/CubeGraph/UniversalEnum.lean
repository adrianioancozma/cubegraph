/-
  ...
  DEPENDENCIES:
  - LawEnum.lean (law/enum definitions, chain, Rank1RequiresEnumeration)
  - Orthogonality.lean (orthogonality theorem, both_necessary)
  - CoverageRate.lean (coverage_rate_deficit, non_affine_coverage_deficit)
  - FinalGap.lean (irreversible_decay_implies_exponential)
...
theorem rank1_is_structure_dependent :
    ...
    -- (2) FAILS on cycles: locally consistent + UNSAT (structure-incompatible)
...
/-! ## Section 10: Honest Gap — What Remains Open
  ...
  PROVEN (1 axiom — schoenebeck_linear):
...
/-- **Theorem count**: 12 theorems in this file. -/
