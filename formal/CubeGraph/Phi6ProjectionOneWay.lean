/-
  CubeGraph/Phi6ProjectionOneWay.lean
  ...
  See: Tau6TwoLevel.lean (projection, lift, level separation)
  ...
  See: AlphaGapConsistency.lean (k-consistency, Borromean order)
-/
...
/-! ## Part 7: Local Inversion Fails
  ...
  This is formalized via k-consistency from AlphaGapConsistency.lean. -/
